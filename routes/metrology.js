...
const metrologies = function(request, response, next){
    ...
    let metData = [{"id_metr":1,"recdate":"2020-05-29T21:00:00.000Z","attestatdate":"2020-05-29T21:00:00.000Z","eqenable":1,"m_type":1,"atttype":1,"att_docpath":null,"protocol_docpath":null,"id_eq_equipment":30,"atestatend":null},
    {"id_metr":2,"recdate":"2020-05-29T21:00:00.000Z","attestatdate":"2020-05-29T21:00:00.000Z","eqenable":0,"m_type":2,"atttype":2,"att_docpath":'1.docx',"protocol_docpath":'2.docx',"id_eq_equipment":30,"atestatend":'2020-05-29T21:00:00.000Z'}]
    ...
    WHERE id_eq_equipment = $1:: INT`, [idEq !== '' ? idEq : 0], function(err, result){
        if (err){
          return next(err)
            ...
            response.status(200).send(metData);//result.rows);
       })
}
const insMetrology = function(request, response, next){
    ...
    db.query(`INSERT INTO Metrology (recdate, attestatdate, eqenable, m_type, atttype, id_eq_equipment, atestatend)
      ...
      metrologyData.eqEnable ? metrologyData.eqEnable : null, metrologyData.M_Type ? metrologyData.M_Type : null, 
      metrologyData.attType ? metrologyData.attType : null, metrologyData.idEq ? metrologyData.idEq : null, 
...
const updMetrology = function(request, response, next){
    ...
    db.query(`UPDATE Metrology 
      ...
      metrologyData.eqEnable !== '' ? metrologyData.eqEnable : null,
      metrologyData.M_Type !== '' ? metrologyData.M_Type : null,
      metrologyData.attType !== '' ? metrologyData.attType : null,
